  ...
  return (
    <>
      <PageHero
        ...
        lines={[
          t("pages.services.line1"),
          <span key="l">
            {t("pages.services.line2Prefix")}{" "}
            <span className="type-serif-accent text-gradient-pink">{t("pages.services.accent")}</span>
          </span>,
          t("pages.services.line3"),
        ]}
              ...
              <FrameReveal className="aspect-[4/3] rounded-md">
                <div className="relative h-full w-full">
                  ...
                  <span className="type-eyebrow absolute bottom-5 left-5 z-10 text-white/60">
                    {t("pages.services.sceneLabel")} {service.index}
                  </span>
                </div>
              </FrameReveal>
            </div>
                ...
                <Magnetic strength={0.25}>
                  ...
                  >
                    <span className="link-line">
                      {t("pages.services.startProject")} {service.title} {t("pages.services.startProjectSuffix")}
                    </span>
                    <ArrowUpRight
